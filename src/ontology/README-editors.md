...
To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/PHI-base/phipo) for details.
 ...
 * https://github.com/PHI-base/phipo/releases
 * https://github.com/PHI-base/phipo/releases/new
...
what is in the `owl:versionIRI` of the derived phipo.owl (`data-version` in
phipo.obo). This will be today's date.
...
Check the build status here: [![Build Status](https://travis-ci.org/PHI-base/phipo.svg?branch=master)](https://travis-ci.org/PHI-base/phipo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/PHI-base](https://travis-ci.org/profile/PHI-base)
 2. click the "Sync account" button
 3. Click the tick symbol next to phipo
